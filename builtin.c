 ...
 * 
 * Output: exits with a given exit status
...
int exit(info_t *info)
{
	...
	if (info->argv[1]) /* Whenever there is an exit argument */
	{
...
/**
 * myhelp - changes the current working directory
 * 
 * @point_to_note: Structure containing needed code.
 * Useful in maintaining constant type prototype.
 * Output: Always 0
 */
